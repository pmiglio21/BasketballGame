            ...
            if (_isJumpStartupFinished && PlayerState != PlayerState.IsRebounding && Input.IsActionJustReleased($"Jump_{TeamIdentifier}"))
            {
                ...
                if (IsInThreePointLine)
                {
                    if (IsInDunkZone && SkillStats.Dunking == GlobalConstants.SkillStatAverage && (moveDirection.X != 0 || moveDirection.Z != 0)) //Doing a layup
                    {
                        ...
                        {
                            basketballDestinationGlobalPosition = nearestLayupPoint.GlobalPosition + new Vector3(0, yOffset, 0);
                        ...
                        else
                        {
                            ...
                            basketballDestinationGlobalPosition = nearestLayupPoint.GlobalPosition + new Vector3(randomXOffset, yOffset, 0);
