...
namespace Levels
{
    public partial class TestBasketballCourtLevel : Node3D
    {
        [Export]
        private PackedScene _basketballPlayerScene;
        ...
        public override void _Ready()
        {
            ...
            foreach (TestBasketballPlayer player in GameManager.Players)
            {
                ...
                {
                    currentPlayer.GlobalPosition = assignedStartPoint.GlobalPosition;
        ...
        //{
        //    foreach (BasketballPlayer basketballPlayer in GameManager.Players)
        //    {
        //        PlayerStartPoint assignedStartPoint = PlayerStartPoints.FirstOrDefault(sp => sp.PlayerIdentifierLONG != 0);
        ...
        //            assignedStartPoint.PlayerIdentifierLONG = basketballPlayer.OnlinePeerId;
        //        }
        //    }
        //}
